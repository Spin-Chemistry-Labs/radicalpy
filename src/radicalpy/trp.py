TRP = {
    ...
    "Halpha": [
        [-0.0601, 0.0037, 0.0331],
        [0.0037, -0.0251, 0.0111],
        [0.0331, 0.0111, -0.1940],
    ],
    "N*": [
        [0.1295, -0.0134, 0.0075],
        [-0.0134, 0.1729, -0.0249],
        [0.0075, -0.0249, 0.1371],
    ],
    "Hbeta2": [
        [0.1634, -0.0230, -0.0064],
        [-0.0230, -0.0082, 0.0158],
        [-0.0064, 0.0158, -0.0182],
    ],
    "H5": [
        [0.0051, 0.0616, 0.0694],
        [0.0616, -0.0665, 0.0391],
        [0.0694, 0.0391, -0.0586],
    ],
}
